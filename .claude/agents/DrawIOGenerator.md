...
# capabilityGap: unmapped tool(s) mcp-drawio-get-shape-categories, mcp-drawio-get-shapes-in-category, mcp-drawio-get-shape-by-name, mcp-drawio-list-layers, mcp-drawio-list-paged-model have no Claude Code equivalent; the surface is narrowed to the mapped tools.
---
