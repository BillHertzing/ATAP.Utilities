...
-- -----------------------------------------------------------------
CREATE TABLE ATAPUtilities._stg_Path_Philote_Primitives (
    PhiloteId NVARCHAR(50)  NOT NULL,
    Comment   NVARCHAR(500)     NULL
);

CREATE TABLE ATAPUtilities._stg_Path_RulePrimitives (
    PhiloteId               NVARCHAR(50)  NOT NULL,
...
CREATE TABLE ATAPUtilities._stg_Path_Philote_Rules (
    PhiloteId NVARCHAR(50)  NOT NULL,
    Comment   NVARCHAR(500)     NULL
);

CREATE TABLE ATAPUtilities._stg_Path_Rules (
    PhiloteId               NVARCHAR(50)  NOT NULL,
    PrimitiveLanguageKindId NVARCHAR(10)  NOT NULL,
    [Name]                  NVARCHAR(200) NOT NULL,
...
CREATE TABLE ATAPUtilities._stg_Path_Philote_Instantiations (
    PhiloteId NVARCHAR(50)  NOT NULL,
    Comment   NVARCHAR(500)     NULL
);

CREATE TABLE ATAPUtilities._stg_Path_Instantiations (
    PhiloteId     NVARCHAR(50)  NOT NULL,
    RulePhiloteId NVARCHAR(50)  NOT NULL,
    Notes         NVARCHAR(MAX)     NULL
);

CREATE TABLE ATAPUtilities._stg_Path_InstantiationBindings (
...
-- -----------------------------------------------------------------
BULK INSERT ATAPUtilities._stg_Path_Philote_Primitives
FROM '${data_dir}\Path_Philote_Primitives.csv'
WITH (FORMAT = 'CSV', FIRSTROW = 2, CODEPAGE = '65001', TABLOCK);

BULK INSERT ATAPUtilities._stg_Path_RulePrimitives
FROM '${data_dir}\Path_RulePrimitives.csv'
WITH (FORMAT = 'CSV', FIRSTROW = 2, CODEPAGE = '65001', TABLOCK);

BULK INSERT ATAPUtilities._stg_Path_Philote_Rules
FROM '${data_dir}\Path_Philote_Rules.csv'
WITH (FORMAT = 'CSV', FIRSTROW = 2, CODEPAGE = '65001', TABLOCK);

BULK INSERT ATAPUtilities._stg_Path_Rules
FROM '${data_dir}\Path_Rules.csv'
WITH (FORMAT = 'CSV', FIRSTROW = 2, CODEPAGE = '65001', TABLOCK);

BULK INSERT ATAPUtilities._stg_Path_Philote_Instantiations
FROM '${data_dir}\Path_Philote_Instantiations.csv'
WITH (FORMAT = 'CSV', FIRSTROW = 2, CODEPAGE = '65001', TABLOCK);

BULK INSERT ATAPUtilities._stg_Path_Instantiations
FROM '${data_dir}\Path_Instantiations.csv'
WITH (FORMAT = 'CSV', FIRSTROW = 2, CODEPAGE = '65001', TABLOCK);

BULK INSERT ATAPUtilities._stg_Path_InstantiationBindings
...
FROM  ATAPUtilities._stg_Path_Philote_Primitives AS s
...
SELECT DISTINCT
    TRY_CONVERT(UNIQUEIDENTIFIER, LTRIM(RTRIM(s.PhiloteId)))
FROM  ATAPUtilities._stg_Path_Philote_Rules AS s
WHERE TRY_CONVERT(UNIQUEIDENTIFIER, LTRIM(RTRIM(s.PhiloteId))) IS NOT NULL
  AND NOT EXISTS (
          SELECT 1
          FROM   ATAPUtilities.Philote AS p
...
SELECT DISTINCT
    TRY_CONVERT(UNIQUEIDENTIFIER, LTRIM(RTRIM(s.PhiloteId)))
FROM  ATAPUtilities._stg_Path_Philote_Instantiations AS s
WHERE TRY_CONVERT(UNIQUEIDENTIFIER, LTRIM(RTRIM(s.PhiloteId))) IS NOT NULL
  AND NOT EXISTS (
          SELECT 1
          FROM   ATAPUtilities.Philote AS p
...
FROM  ATAPUtilities._stg_Path_Instantiations AS s
WHERE TRY_CONVERT(UNIQUEIDENTIFIER, LTRIM(RTRIM(s.PhiloteId)))     IS NOT NULL
...
FROM  ATAPUtilities._stg_Path_InstantiationBindings AS s
...
IF OBJECT_ID('ATAPUtilities._stg_Path_Philote_Primitives',     'U') IS NOT NULL DROP TABLE ATAPUtilities._stg_Path_Philote_Primitives;
IF OBJECT_ID('ATAPUtilities._stg_Path_RulePrimitives',         'U') IS NOT NULL DROP TABLE ATAPUtilities._stg_Path_RulePrimitives;
IF OBJECT_ID('ATAPUtilities._stg_Path_Philote_Rules',          'U') IS NOT NULL DROP TABLE ATAPUtilities._stg_Path_Philote_Rules;
IF OBJECT_ID('ATAPUtilities._stg_Path_Rules',                  'U') IS NOT NULL DROP TABLE ATAPUtilities._stg_Path_Rules;
IF OBJECT_ID('ATAPUtilities._stg_Path_Philote_Instantiations', 'U') IS NOT NULL DROP TABLE ATAPUtilities._stg_Path_Philote_Instantiations;
IF OBJECT_ID('ATAPUtilities._stg_Path_Instantiations',         'U') IS NOT NULL DROP TABLE ATAPUtilities._stg_Path_Instantiations;
IF OBJECT_ID('ATAPUtilities._stg_Path_InstantiationBindings',  'U') IS NOT NULL DROP TABLE ATAPUtilities._stg_Path_InstantiationBindings;
