...
| G-17 | `Publish-PSModuleToProGetFeed` tries `$global:settings` first then falls back to User-scope env var `PROGET_POWERSHELLGET_FEED_URI_<TIER>`. BuildMaster agents work without populated globals. |
