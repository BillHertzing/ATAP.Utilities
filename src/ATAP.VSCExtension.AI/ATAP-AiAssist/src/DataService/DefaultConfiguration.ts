...
export class DefaultConfiguration {
  ...
  static Production: Record<string, AllowedTypesInValue> = {
    ...
    queryFragmentsFileName: "queryFragments.json",
    conversationsFileName: "Conversations.json",
    cloudBasePath: "C:\\Dropbox",
    DataServiceAsSerializationStructure: new SerializationStructure(
      SupportedSerializersEnum.Yaml,
      "{}",
    ),
    extensionID: "ataputilities.atap-aiassist",
    KeePassKDBXPath:
      "C:\\Dropbox\\whertzing\\GitHub\\ATAP.IAC\\Security\\.PSVaultATAP_secrets.kdbx",
