...
| [Package.VersionReuse.Tests.ps1](Package.VersionReuse.Tests.ps1) | RepoHealth gate for the Task 15.181.i Option B policy: the protected Configuration source fingerprint must remain exact for a manually selected package version; a changed fingerprint requires a new version. |
