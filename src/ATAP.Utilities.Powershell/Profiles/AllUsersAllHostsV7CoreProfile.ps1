...
# Write-ArrayIndented, Write-HashIndented, Write-KVPIndented, and Write-EnvironmentVariablesIndented
# were moved into the ATAP.Utilities.PowerShell module (public/) as part of SC-0183.
# They are available via module autoloading (stable) or dot-sourcing (sprint worktree).
