...
namespace ATAP.Utilities.GenerateProgram {
  ...
  public static partial class RenderExtensions {
    public static StringBuilder RenderNamespaceDeclarationStringBuilder(this StringBuilder sb, IGNamespace gNamespace, StringBuilder indent, string eol, CancellationToken? ct = default) {
      ct?.ThrowIfCancellationRequested();
      return sb.Append($"{indent}namespace {gNamespace.GName} {{{eol}");
    }
    public static StringBuilder RenderNamespaceTerminationStringBuilder(this StringBuilder sb, StringBuilder indent, string eol, CancellationToken? ct = default) {
      ct?.ThrowIfCancellationRequested();
      return sb.Append($"{indent}}}{eol}");
    }
    public static IR1Top RNamespace(this IR1Top r1Top, IGNamespace gNamespace) {
