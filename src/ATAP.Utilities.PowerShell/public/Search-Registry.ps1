...
<#
  ...
  ToDo: This code was copied from a StackOverflow answer. A great start, it needs updates to fit ATAP.Utilities expectations.
...
.LINK
[Rohn Edwards](https://stackoverflow.com/users/3874447/rohn-edwards)
.SCM
