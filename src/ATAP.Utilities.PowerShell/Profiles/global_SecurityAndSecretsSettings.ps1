...
$local:SecurityAndSecretsSettings = [ordered]@{
  ...
  $global:configRootKeys['CertificateSecurityCertificateSerialNumberPathConfigRootKey']      = 'join-path $global:settings[$global:configRootKeys["CertificateSecurityBasePathConfigRootKey"]] "CertificateSerialNumber.txt"'
  $global:configRootKeys['CertificateSecurityCertificateIssuedDBPathConfigRootKey']          = 'join-path $global:settings[$global:configRootKeys["CertificateSecurityBasePathConfigRootKey"]] "CertificateIssuedDB"'
