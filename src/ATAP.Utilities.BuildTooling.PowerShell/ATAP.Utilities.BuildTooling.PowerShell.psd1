...
@{
    ...
    'Build-PSModulePsm1', 'check-syntax',
    'Clear-BuildMasterSprintVariables', 'Clear-NuGetCaches',
    'Clear-SprintGeneratedArtifacts', 'Clear-VSCCaches',
    ...
    'New-SprintBitwardenSecrets', 'New-SprintSqlServerInstances',
    'New-SprintStage1', 'New-SprintStage2', 'New-WorktreeWithJunctions',
    'Publish-PSModuleToProGetFeed', 'Publish-PSPackage',
    ...
    'Start-DebugPowerShell', 'Start-PlanningSession', 'Sync-RulesToCSV',
