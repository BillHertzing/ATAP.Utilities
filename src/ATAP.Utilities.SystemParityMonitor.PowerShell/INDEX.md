...
| `ATAP.Utilities.SystemParityMonitor.PowerShell.psd1` | Module manifest (exports the eight public functions) |
...
| `public\` | Exported functions: Add-ParityChangeEntry, Get-ParityPrimaryRole, Set-ParityPrimaryRole, Get-PeerPendingChanges, Confirm-ParityChangeApplied, Invoke-ParityAudit, Invoke-SharedDotNetToolConsumerProbe, Compare-ParityAudits |
| `private\` | Internal helpers (journal/ack/snapshot paths, atomic JSON and JSONL IO, surface map, whitelist, SQL, package-manager, shared .NET tool and required-change evidence collection, normalized-name conflict detection, native-command adapter, logging shim) |
...
| `tests\Unit\Task15167SharedDotNetTools.Tests.ps1` | Focused shared .NET tool, consumer identity/evidence, required journal acknowledgement, public comparison, and scheduled-alert regressions |
