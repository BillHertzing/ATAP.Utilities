@{
  ...
  Members = @(
    ...
    @{ Name = 'ATAP.Utilities.BuildTooling.PowerShell'; Guid = 'DBD8663F-C30C-4702-B97A-5365529B4D15'; Dependencies = @('ATAP.Utilities.BuildTooling.PesterScaffolding.PowerShell', 'ATAP.Utilities.BuildTooling.GitWorktree.PowerShell', 'ATAP.Utilities.BuildTooling.PlanningSession.PowerShell'); MinimumVersions = @{ 'ATAP.Utilities.BuildTooling.PesterScaffolding.PowerShell' = '0.1.1'; 'ATAP.Utilities.BuildTooling.GitWorktree.PowerShell' = '0.1.3'; 'ATAP.Utilities.BuildTooling.PlanningSession.PowerShell' = '0.1.0' } }
  )
}
