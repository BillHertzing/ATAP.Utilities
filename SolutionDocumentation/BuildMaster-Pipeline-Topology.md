...
| ----------------- | ------------------------------------ | ----------------------------------------------- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| C# Package        | `CSharpPackage-5Stage.otter`         | `ATAP.Utilities-CSharp`, `AceCommander`         | `nuget-stable`             | Shared plan; package identity is supplied per build by repository monitors or manual build variables. C# pipelines run `Build\Invoke-RepoHealthGate.ps1` after restore and before pack/publish for repo-wide `Directory.Build.props` checks. |
