# Build-All script for Philotes database
# This script builds the Philotes database and loads initial data

# Set the database name
$databaseName = 'Philote'
...
try {
  ...
  Write-PSFMessage -Level Important -Message "=== Philotes Database Build Complete ==="
}
catch {
