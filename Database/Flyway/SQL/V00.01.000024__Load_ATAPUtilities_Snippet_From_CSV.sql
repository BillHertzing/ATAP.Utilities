...
-- -----------------------------------------------------------------
CREATE TABLE ATAPUtilities._stg_Snippet_Philote_Primitives (
    PhiloteId NVARCHAR(50)  NOT NULL,
    Comment   NVARCHAR(500)     NULL
);

CREATE TABLE ATAPUtilities._stg_Snippet_RulePrimitives (
    PhiloteId               NVARCHAR(50)  NOT NULL,
...
CREATE TABLE ATAPUtilities._stg_Snippet_Philote_Rules (
    PhiloteId NVARCHAR(50)  NOT NULL,
    Comment   NVARCHAR(500)     NULL
);

CREATE TABLE ATAPUtilities._stg_Snippet_Rules (
    PhiloteId               NVARCHAR(50)  NOT NULL,
    PrimitiveLanguageKindId NVARCHAR(10)  NOT NULL,
    [Name]                  NVARCHAR(200) NOT NULL,
...
CREATE TABLE ATAPUtilities._stg_Snippet_Philote_Instantiations (
    PhiloteId NVARCHAR(50)  NOT NULL,
    Comment   NVARCHAR(500)     NULL
);

CREATE TABLE ATAPUtilities._stg_Snippet_Instantiations (
    PhiloteId     NVARCHAR(50)  NOT NULL,
    RulePhiloteId NVARCHAR(50)  NOT NULL,
    Notes         NVARCHAR(MAX)     NULL
);

CREATE TABLE ATAPUtilities._stg_Snippet_InstantiationBindings (
...
-- -----------------------------------------------------------------
BULK INSERT ATAPUtilities._stg_Snippet_Philote_Primitives
FROM '${data_dir}\Snippet_Philote_Primitives.csv'
WITH (FORMAT = 'CSV', FIRSTROW = 2, CODEPAGE = '65001', TABLOCK);

BULK INSERT ATAPUtilities._stg_Snippet_RulePrimitives
FROM '${data_dir}\Snippet_RulePrimitives.csv'
WITH (FORMAT = 'CSV', FIRSTROW = 2, CODEPAGE = '65001', TABLOCK);

BULK INSERT ATAPUtilities._stg_Snippet_Philote_Rules
FROM '${data_dir}\Snippet_Philote_Rules.csv'
WITH (FORMAT = 'CSV', FIRSTROW = 2, CODEPAGE = '65001', TABLOCK);

BULK INSERT ATAPUtilities._stg_Snippet_Rules
FROM '${data_dir}\Snippet_Rules.csv'
WITH (FORMAT = 'CSV', FIRSTROW = 2, CODEPAGE = '65001', TABLOCK);

BULK INSERT ATAPUtilities._stg_Snippet_Philote_Instantiations
FROM '${data_dir}\Snippet_Philote_Instantiations.csv'
WITH (FORMAT = 'CSV', FIRSTROW = 2, CODEPAGE = '65001', TABLOCK);

BULK INSERT ATAPUtilities._stg_Snippet_Instantiations
FROM '${data_dir}\Snippet_Instantiations.csv'
WITH (FORMAT = 'CSV', FIRSTROW = 2, CODEPAGE = '65001', TABLOCK);

BULK INSERT ATAPUtilities._stg_Snippet_InstantiationBindings
...
FROM  ATAPUtilities._stg_Snippet_Philote_Primitives AS s
...
FROM  ATAPUtilities._stg_Snippet_RulePrimitives AS s
WHERE TRY_CONVERT(UNIQUEIDENTIFIER, LTRIM(RTRIM(s.PhiloteId))) IS NOT NULL
...
SELECT DISTINCT
    TRY_CONVERT(UNIQUEIDENTIFIER, LTRIM(RTRIM(s.PhiloteId)))
FROM  ATAPUtilities._stg_Snippet_Philote_Rules AS s
WHERE TRY_CONVERT(UNIQUEIDENTIFIER, LTRIM(RTRIM(s.PhiloteId))) IS NOT NULL
  AND NOT EXISTS (
          SELECT 1
          FROM   ATAPUtilities.Philote AS p
...
FROM  ATAPUtilities._stg_Snippet_Rules AS s
WHERE TRY_CONVERT(UNIQUEIDENTIFIER, LTRIM(RTRIM(s.PhiloteId))) IS NOT NULL
  AND TRY_CONVERT(TINYINT,          LTRIM(RTRIM(s.PrimitiveLanguageKindId))) = 5
  AND NULLIF(LTRIM(RTRIM(s.[Name])), N'') IS NOT NULL
  AND NOT EXISTS (
...
SELECT DISTINCT
    TRY_CONVERT(UNIQUEIDENTIFIER, LTRIM(RTRIM(s.PhiloteId)))
FROM  ATAPUtilities._stg_Snippet_Philote_Instantiations AS s
WHERE TRY_CONVERT(UNIQUEIDENTIFIER, LTRIM(RTRIM(s.PhiloteId))) IS NOT NULL
  AND NOT EXISTS (
          SELECT 1
          FROM   ATAPUtilities.Philote AS p
...
FROM  ATAPUtilities._stg_Snippet_Instantiations AS s
WHERE TRY_CONVERT(UNIQUEIDENTIFIER, LTRIM(RTRIM(s.PhiloteId)))     IS NOT NULL
...
FROM  ATAPUtilities._stg_Snippet_InstantiationBindings AS s
...
IF OBJECT_ID('ATAPUtilities._stg_Snippet_Philote_Primitives',     'U') IS NOT NULL DROP TABLE ATAPUtilities._stg_Snippet_Philote_Primitives;
IF OBJECT_ID('ATAPUtilities._stg_Snippet_Philote_Rules',           'U') IS NOT NULL DROP TABLE ATAPUtilities._stg_Snippet_Philote_Rules;
IF OBJECT_ID('ATAPUtilities._stg_Snippet_RulePrimitives',          'U') IS NOT NULL DROP TABLE ATAPUtilities._stg_Snippet_RulePrimitives;
IF OBJECT_ID('ATAPUtilities._stg_Snippet_Rules',                   'U') IS NOT NULL DROP TABLE ATAPUtilities._stg_Snippet_Rules;
IF OBJECT_ID('ATAPUtilities._stg_Snippet_Philote_Instantiations',  'U') IS NOT NULL DROP TABLE ATAPUtilities._stg_Snippet_Philote_Instantiations;
IF OBJECT_ID('ATAPUtilities._stg_Snippet_Instantiations',          'U') IS NOT NULL DROP TABLE ATAPUtilities._stg_Snippet_Instantiations;
IF OBJECT_ID('ATAPUtilities._stg_Snippet_InstantiationBindings',   'U') IS NOT NULL DROP TABLE ATAPUtilities._stg_Snippet_InstantiationBindings;