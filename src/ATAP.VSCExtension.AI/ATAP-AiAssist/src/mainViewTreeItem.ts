...
export class mainViewTreeItem extends vscode.TreeItem {
  ...
  constructor(label: string, collapsibleState: vscode.TreeItemCollapsibleState, logger: Logger, public readonly properties: any) { //guid: string, pickedValue: string,  public properties: any
