...
namespace ATAP.Utilities.ComputerInventory
{
    ...
    public class ComputerHardware : OpenHardwareMonitor.Hardware.Computer
    {
        ...
        // ToDo: Get teh HardwareMonitorLib to work, right now, it thows an exception it can't find system.management dll
        //computer.Open();
        }
        ...
        public TimeBlock Moment { get => moment; set => moment = value; }
