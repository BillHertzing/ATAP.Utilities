...
namespace ATAP.Utilities.GenerateProgram {
  public static partial class RenderExtensions {
    ...
    public static IR1Top RConstStringGroup(this IR1Top r1Top, IEnumerable<IGConstStringGroup> gConstStringGroups) {
      foreach (var o in gConstStringGroups) {
        r1Top.RConstStringGroup(o);
      }
      return r1Top;
    }
    public static IR1Top RConstStringGroup(this IR1Top r1Top, IDictionary<IPhilote<IGConstStringGroup>, IGConstStringGroup> gConstStringGroups) {
      foreach (var o in gConstStringGroups) {
