...
| ------------------------ | ------------------------------------------------------------- | ----------------------- |
| Sprint / Experimental    | `dbConnectionString.ATAPUtilities.<Host>.Exp.<User>`          | `<Host>\Exp<username>`  |
| Alpha (Development)      | `dbConnectionString.ATAPUtilities.<Host>.Dev.<User>`          | `<Host>\Dev<username>`  |
