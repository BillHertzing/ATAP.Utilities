...
BEGIN TRY
    ...
    BEGIN
        ...
        (
            ...
            EntityId BIGINT NOT NULL,
            EntityTypeId BIGINT NOT NULL,
            EntityTypeCode VARCHAR(128) NOT NULL,
...
BEGIN TRY
    ...
    BEGIN
        ...
        (
            ...
            EntityId BIGINT NOT NULL,
            EntityTypeId BIGINT NOT NULL,
            EntityTypeCode AS CONVERT(VARCHAR(128), 'instantiation') PERSISTED,
    ...
    BEGIN
        ...
        (
            ...
            EntityId BIGINT NOT NULL,
            EntityTypeId BIGINT NOT NULL,
            EntityTypeCode AS CONVERT(VARCHAR(128), 'instantiation-version') PERSISTED,
    ...
    BEGIN
        ...
        (
            ...
            EntityId BIGINT NOT NULL,
            EntityTypeId BIGINT NOT NULL,
            EntityTypeCode AS CONVERT(VARCHAR(128), 'input-block') PERSISTED,
    ...
    BEGIN
        ...
        (
            ...
            EntityId BIGINT NOT NULL,
            EntityTypeId BIGINT NOT NULL,
            EntityTypeCode AS CONVERT(VARCHAR(128), 'input-block-version') PERSISTED,
...
BEGIN
    ...
    BEGIN TRANSACTION;
    BEGIN TRY
        DECLARE @FixtureNow DATETIME2(7) = SYSUTCDATETIME();
        ...
        DECLARE @ArtifactTypeId BIGINT =
            (SELECT EntityTypeId FROM ATAPUtilities.EntityType WHERE EntityTypeCode = 'manifestation-artifact');
        IF @PlanTypeId IS NULL OR @ApprovalTypeId IS NULL OR @ManifestationTypeId IS NULL OR @ArtifactTypeId IS NULL
        ...
        SELECT TOP (1)
            ...
            @BuildSetVersionId = o.BuildSetVersionId,
        ...
        DECLARE @AuthorityEntityId BIGINT;
        DECLARE @AuthorityEntityTypeId BIGINT;
        SELECT TOP (1) @AuthorityEntityId = EntityId, @AuthorityEntityTypeId = EntityTypeId
        FROM ATAPUtilities.Entity ORDER BY EntityId;

        INSERT ATAPUtilities.Entity (EntityTypeId, EntityPhiloteId, CreatedAtUtc)
        VALUES (@PlanTypeId, '45000000-0000-0000-0000-000000000001', @FixtureNow);
        DECLARE @PlanEntityId BIGINT = CONVERT(BIGINT, SCOPE_IDENTITY());
        INSERT ATAPUtilities.Entity (EntityTypeId, EntityPhiloteId, CreatedAtUtc)
        VALUES (@ApprovalTypeId, '45000000-0000-0000-0000-000000000002', @FixtureNow);
        DECLARE @ApprovalEntityId BIGINT = CONVERT(BIGINT, SCOPE_IDENTITY());
        INSERT ATAPUtilities.Entity (EntityTypeId, EntityPhiloteId, CreatedAtUtc)
        VALUES (@ManifestationTypeId, '45000000-0000-0000-0000-000000000003', @FixtureNow);
        DECLARE @ManifestationEntityId BIGINT = CONVERT(BIGINT, SCOPE_IDENTITY());
        INSERT ATAPUtilities.Entity (EntityTypeId, EntityPhiloteId, CreatedAtUtc)
        VALUES (@ArtifactTypeId, '45000000-0000-0000-0000-000000000004', @FixtureNow);
        ...
        VALUES ('45000000-0000-0000-0000-000000000001', @PlanEntityId, @PlanTypeId,
                ...
                450003, 'sha256', @PlanFingerprint, @FixtureNow);
        ...
        VALUES ('45000000-0000-0000-0000-000000000002', @ApprovalEntityId,
                ...
                @AuthorityEntityId, @AuthorityEntityTypeId, 450005, 'approved',
                @FixtureNow, DATEADD(hour, 1, @FixtureNow));
        ...
        VALUES (@ManifestationId, 1, NULL, 450007, 'rdb450-fixture',
                ...
                DATEADD(minute, 10, @FixtureNow), @FixtureNow, @FixtureNow,
                DATEADD(second, 1, @FixtureNow), 'succeeded', NULL);
        ...
        INSERT ATAPUtilities.RuleExecution
            (ManifestationAttemptId, BuildSetRuleOccurrenceId, BuildSetVersionId,
             ...
             LeaseHolderReference, LeaseToken, OutcomeCode, StartedAtUtc,
             FinishedAtUtc, ExecutionFingerprint)
        VALUES (@AttemptId, @OccurrenceId, @BuildSetVersionId, @OccurrenceKey,
                @RuleVersionId, 0, 450007, 'rdb450-fixture',
                '45000000-0000-0000-0000-000000000005', 'succeeded', @FixtureNow,
                DATEADD(millisecond, 500, @FixtureNow),
        ...
        INSERT ATAPUtilities.ManifestationEvent
            (ManifestationAttemptId, EventSequence, EventKindCode, OccurredAtUtc,
             ...
             DiagnosticHash)
        VALUES (@AttemptId, 1, 'rule-succeeded', DATEADD(millisecond, 500, @FixtureNow),
        ...
        VALUES ('45000000-0000-0000-0000-000000000004', @ArtifactEntityId,
                @ArtifactTypeId, @ManifestationId, @PlanId, @AttemptId,
                @ExecutionId, @RuleVersionId, 'succeeded', @PlanArtifactId,
                'rdb450://fixture/output', @ExpectedHash, 8,
                DATEADD(second, 1, @FixtureNow), 'produced', NULL);
        ...
        FROM ATAPUtilities.RuleVersion WHERE RuleVersionId = @RuleVersionId;
        ...
        VALUES (@SubjectEntityId, @SubjectEntityTypeId, @SubjectEntityId,
                @SubjectEntityTypeId, @RuleVersionId, 'execution', 'observed',
                NULL, @AttemptId, @ExecutionId, DATEADD(second, 1, @FixtureNow),
                HASHBYTES('SHA2_256', 'RDB-450-usage'));

        /* Negative: duplicate slot, gapped event, and mutation are rejected. */
        BEGIN TRY
            INSERT ATAPUtilities.PlanArtifact
                (ManifestationPlanId, SlotOrdinal, CanonicalLocator,
                 LocatorPolicyVersionId, EffectClassCode, ExpectedContentHash,
        ...
        BEGIN TRY
            INSERT ATAPUtilities.ManifestationEvent
                (ManifestationAttemptId, EventSequence, EventKindCode, OccurredAtUtc)
            VALUES (@AttemptId, 3, 'lease-heartbeat', DATEADD(second, 2, @FixtureNow));
...
BEGIN TRY
    ...
    BEGIN
        ...
        (
            ...
            [ErrorTaxonomyCode] varchar(128) NULL,
...
INNER JOIN [Tags].[Tags] AS [t] ON [r].[TargetTagID] = [t].[TagID];';
    ...
    /* Rollback-only executable contract fixtures. */
    ...
    BEGIN
        SAVE TRANSACTION Rdb460Fixtures;
        SET XACT_ABORT OFF;
        ...
        IF @OrganizationTypeId IS NULL OR @RepositoryTypeId IS NULL
           OR @ArtifactTypeId IS NULL OR @SummaryTypeId IS NULL
        ...
        VALUES
            ('classification', 'rdb460-fixture', 1, HASHBYTES('SHA2_256', 'classification'), @FixtureNow),
            ('selection', 'rdb460-fixture', 1, HASHBYTES('SHA2_256', 'selection'), @FixtureNow),
            ('redaction', 'rdb460-fixture', 1, HASHBYTES('SHA2_256', 'redaction'), @FixtureNow),
            ('acceptance', 'rdb460-fixture', 1, HASHBYTES('SHA2_256', 'acceptance'), @FixtureNow),
            ('projection-owner', 'rdb460-fixture', 1, HASHBYTES('SHA2_256', 'projection-owner'), @FixtureNow);
        DECLARE @ClassificationPolicyVersionId bigint =
        ...
        VALUES (@OrganizationTypeId, @OrganizationPhilote, @FixtureNow);
        ...
        VALUES (@OrganizationPhilote, @OrganizationEntityId, @OrganizationTypeId,
                N'rdb-460-fixture-organization', @ClassificationPolicyVersionId, @FixtureNow);
        ...
        INSERT INTO [ATAPUtilities].[Entity] ([EntityTypeId], [EntityPhiloteId], [CreatedAtUtc])
        VALUES (@RepositoryTypeId, @RepositoryPhilote, @FixtureNow);
        ...
        VALUES (@RepositoryPhilote, @RepositoryEntityId, @RepositoryTypeId,
                @OrganizationId, N'rdb-460-fixture-repository', @ClassificationPolicyVersionId, @FixtureNow);
        ...
        INSERT INTO [ATAPUtilities].[Entity] ([EntityTypeId], [EntityPhiloteId], [CreatedAtUtc])
        VALUES (@RepositoryTypeId, @OtherRepositoryPhilote, @FixtureNow);
        ...
        VALUES (@OtherRepositoryPhilote, @OtherRepositoryEntityId, @RepositoryTypeId,
                @OrganizationId, N'rdb-460-fixture-other-repository', @ClassificationPolicyVersionId, @FixtureNow);
        ...
        VALUES
            (@RepositoryId, N'c:\rdb460-fixture\stable', HASHBYTES('SHA2_256', CONVERT(varbinary(max), N'c:\rdb460-fixture\stable')), 'stable', @FixtureNow, N'fixture:root:stable'),
            (@RepositoryId, N'c:\rdb460-fixture\sprint', HASHBYTES('SHA2_256', CONVERT(varbinary(max), N'c:\rdb460-fixture\sprint')), 'sprint', @FixtureNow, N'fixture:root:sprint');
        ...
        VALUES (@RepositoryId, N'src/module', HASHBYTES('SHA2_256', CONVERT(varbinary(max), N'src/module')), 'source-module', @FixtureNow);
        ...
        INSERT INTO [ATAPUtilities].[Entity] ([EntityTypeId], [EntityPhiloteId], [CreatedAtUtc])
        VALUES (@ArtifactTypeId, @ArtifactPhiloteA, @FixtureNow);
        ...
        INSERT INTO [ATAPUtilities].[SourceArtifact]
            ([SourceArtifactPhiloteId], [EntityId], [EntityTypeId], [RepositoryId], [SourceModuleId],
             ...
             [CreatedAtUtc])
        VALUES (@ArtifactPhiloteA, @ArtifactEntityIdA, @ArtifactTypeId, @RepositoryId, @SourceModuleId,
                'RepositoryPath', N'src/module/a.sql', HASHBYTES('SHA2_256', CONVERT(varbinary(max), N'src/module/a.sql')), N'fixture:path-normalizer:v1', @FixtureNow);
        ...
        INSERT INTO [ATAPUtilities].[Entity] ([EntityTypeId], [EntityPhiloteId], [CreatedAtUtc])
        VALUES (@ArtifactTypeId, @ArtifactPhiloteB, @FixtureNow);
        DECLARE @ArtifactEntityIdB bigint = CONVERT(bigint, SCOPE_IDENTITY());
        INSERT INTO [ATAPUtilities].[SourceArtifact]
            ([SourceArtifactPhiloteId], [EntityId], [EntityTypeId], [RepositoryId], [SourceModuleId],
             [LocatorTypeCode], [RepoRelativePathOrExternalLocator], [LocatorIdentityHash], [LocatorNormalizerIdentityReference],
             [CreatedAtUtc])
        VALUES (@ArtifactPhiloteB, @ArtifactEntityIdB, @ArtifactTypeId, @RepositoryId, @SourceModuleId,
                'RepositoryPath', N'src/module/b.sql', HASHBYTES('SHA2_256', CONVERT(varbinary(max), N'src/module/b.sql')), N'fixture:path-normalizer:v1', @FixtureNow);
        ...
        VALUES (@ArtifactIdA, 1, REPLICATE('a', 64), REPLICATE('c', 64), 1, 'utf-8', 0, 'lf', 1,
                N'fixture:extractor', N'fixture:harvester', @FixtureNow, HASHBYTES('SHA2_256', N'rdb460:a'));
        ...
        VALUES (@ArtifactIdB, 1, REPLICATE('b', 64), REPLICATE('d', 64), 1, 'utf-8', 0, 'lf', 1,
                N'fixture:extractor', N'fixture:harvester', @FixtureNow, HASHBYTES('SHA2_256', N'rdb460:b'));
        ...
        BEGIN TRY
            ...
            VALUES (@ArtifactIdA, 3, REPLICATE('e', 64), 1, 'utf-8', 0, 'lf', 1,
                    N'fixture:extractor', N'fixture:harvester', @FixtureNow,
        ...
        VALUES (@ArtifactIdA, @RepositoryId, @ArtifactIdB, @RepositoryId, 'RenamedFrom', @AcceptancePolicyVersionId,
                ...
                N'fixture:lineage-proposal', @FixtureNow);

        DECLARE @SummaryPhilote uniqueidentifier = '46000000-0000-0000-0000-000000000006';
        INSERT INTO [ATAPUtilities].[Entity] ([EntityTypeId], [EntityPhiloteId], [CreatedAtUtc])
        VALUES (@SummaryTypeId, @SummaryPhilote, @FixtureNow);
        ...
        VALUES (@SummaryPhilote, @SummaryEntityId, @SummaryTypeId, @ArtifactIdA,
                'fixture-safe', @ClassificationPolicyVersionId, @FixtureNow);
        ...
        VALUES (@ContentSummaryId, @ArtifactIdA, @ArtifactVersionIdA, @ClassificationPolicyVersionId, 1, 'harvested', @FixtureNow);
        ...
        VALUES (@ContentSummaryVersionId, 0, 'primary-source', @ArtifactVersionIdA,
                @FixtureNow, N'fixture:dependency-evidence');
        ...
        VALUES (N'RDB-460 fixture', N'<rdb460@example.invalid>', N'sender@example.invalid',
                N'recipient@example.invalid', @FixtureNow, N'fixture', N'rollback-only',
                N'https://example.invalid/rdb460');

        /* Negative I-18: an active normalized root cannot identify two repositories. */
        BEGIN TRY
            INSERT INTO [ATAPUtilities].[RepositoryRootRegistration]
                ([RepositoryId], [NormalizedAbsoluteRoot], [NormalizedAbsoluteRootHash], [RootKindCode], [RegisteredAtUtc], [RegistrarEvidenceReference])
            VALUES (@OtherRepositoryId, N'c:\rdb460-fixture\stable', HASHBYTES('SHA2_256', CONVERT(varbinary(max), N'c:\rdb460-fixture\stable')), 'stable', @FixtureNow, N'fixture:duplicate-root');
        ...
        INSERT INTO [ATAPUtilities].[Entity] ([EntityTypeId], [EntityPhiloteId], [CreatedAtUtc])
        VALUES (@ArtifactTypeId, @InvalidArtifactPhilote, @FixtureNow);
        ...
        BEGIN TRY
            INSERT INTO [ATAPUtilities].[SourceArtifact]
                ([SourceArtifactPhiloteId], [EntityId], [EntityTypeId], [RepositoryId],
                 [LocatorTypeCode], [RepoRelativePathOrExternalLocator], [LocatorIdentityHash], [LocatorNormalizerIdentityReference],
                 [CreatedAtUtc])
            VALUES (@InvalidArtifactPhilote, @InvalidArtifactEntityId, @ArtifactTypeId,
                    @RepositoryId, 'RepositoryPath', N'..\escape.sql', HASHBYTES('SHA2_256', CONVERT(varbinary(max), N'..\escape.sql')), N'fixture:path-normalizer:v1', @FixtureNow);
        ...
        BEGIN TRY
            ...
            VALUES (@ContentSummaryId, @ArtifactIdA, @ArtifactVersionIdB, @ClassificationPolicyVersionId, 2,
                    @ContentSummaryVersionId, 'retired', @RedactionPolicyVersionId, @FixtureNow);
        ...
        BEGIN TRY
            ...
            VALUES (@ContentSummaryId, @ArtifactIdA, @ArtifactVersionIdA, @ClassificationPolicyVersionId, 2,
                    @ContentSummaryVersionId, 'excluded', @RedactionPolicyVersionId, N'fixture:excluded', N'unsafe', @FixtureNow);
        ...
        ROLLBACK TRANSACTION Rdb460Fixtures;
        SET XACT_ABORT ON;
    END;
