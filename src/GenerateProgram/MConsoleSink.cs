...
/*
      ...
      gAttributeGroup = CreateLocalizableEnumerationAttributeGroup(description: "Signal to the Console Monitor that we are a valid ConsoleSink",visualDisplay: "Initiate Contact",visualSortOrder: 2);
      gAttributeGroups[gAttributeGroup.Philote] = gAttributeGroup;
      ...
      gAttributeGroups = new Dictionary<Philote<GAttributeGroup>, GAttributeGroup>();
      gAttributeGroup = CreateLocalizableEnumerationAttributeGroup(description:"Initialization has completed", visualDisplay:"InitializationComplete Received", visualSortOrder:1);
      gAttributeGroups[gAttributeGroup.Philote] = gAttributeGroup;
      gEnumerationMemberList.Add(
