---
name: collate-material
description: "Collates ordered source files into one Markdown handoff while preserving their contents."
tools:
  - view_file
  - list_dir
  - grep_search
...
SourceId: ai.agent.collate-material.v1
Source: .ai/agents/collate-material.agent.md
SourceSha256: a99bb381b9553a2a3782a441cbaf868e6f198d196f481999f8490af85ef13c86
...
If the default output folder does not exist, ask the user for an existing output folder.
...
5. Verify the output directory exists; if it does not, ask for an existing destination.
