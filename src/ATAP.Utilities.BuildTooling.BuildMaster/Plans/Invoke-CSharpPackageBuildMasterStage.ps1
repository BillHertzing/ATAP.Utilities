...
# invokes this runner via `pwsh -NoProfile -File`, so the ATAP profile that builds
# $global:settings never loads — that absence is by design here. Setting this marker
