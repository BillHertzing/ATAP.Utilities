...
| `BuildMaster-Pipeline-Topology.md`                | The three durable BuildMaster pipelines (C#, PowerShell, Release Bundle); PowerShell automation surface; ProGet-webhook → BuildMaster integration.                   | **written** — [BuildMaster-Pipeline-Topology.md](BuildMaster-Pipeline-Topology.md)                    | spec (all 13 documented cmdlets are spec — file-existence audit on 2026-05-08; related cmdlets `Move-ProGetPackageInterTier` / `Move-ProGetPackageIntraTier` exist) |
