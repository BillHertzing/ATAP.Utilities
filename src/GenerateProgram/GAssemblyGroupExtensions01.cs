...
namespace GenerateProgram {
  ...
  public static partial class GAssemblyGroupExtensions {
    ...
    public static GAssemblyGroup GAssemblyGroupGHHSWithEmbeddedDataConstructor(string gAssemblyGroupName = default, string subDirectoryForGeneratedFiles = default, string baseNamespace = default) {
