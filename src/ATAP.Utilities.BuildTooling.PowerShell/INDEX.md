...
| [Test-PowerShellSyntax.ps1](public/Test-PowerShellSyntax.ps1)                                                               | Parses a target `.ps1` file with the PowerShell AST parser and reports syntax errors. (Dev/debug utility.)      |
...
| [Get-TierFromNBGVLabel.ps1](public/Get-TierFromNBGVLabel.ps1)                                             | Compatibility helper that maps an NBGV prerelease label to a ceiling tier and canonical lowercase `powershellget-*` feed. |
| [Get-TierOrder.ps1](public/Get-TierOrder.ps1)                                                           | Returns the canonical ordered tier list used by promotion-ceiling guards.                                      |
...
| [Test-PromotionWithinCeiling.ps1](public/Test-PromotionWithinCeiling.ps1)                                | Throws or returns false when a stage or promotion destination is above the label-derived ceiling tier.          |
...
| [Get-BuildContext.Ceiling.Tests.ps1](tests/Unit/Get-BuildContext.Ceiling.Tests.ps1)                                  | `Get-BuildContext` — CurrentTier/CeilingTier split and deprecated Tier alias.                                       |
| [Get-TierFromNBGVLabel.Tests.ps1](tests/Unit/Get-TierFromNBGVLabel.Tests.ps1)                                        | `Get-TierFromNBGVLabel` — compatibility ceiling-label parsing.                                                      |
...
| [Test-PromotionWithinCeiling.Tests.ps1](tests/Unit/Test-PromotionWithinCeiling.Tests.ps1)                            | `Test-PromotionWithinCeiling` — ordered ceiling guard behavior and structured error.                                |
