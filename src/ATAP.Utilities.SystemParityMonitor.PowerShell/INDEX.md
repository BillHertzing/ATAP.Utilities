...
| `private\` | Internal helpers (journal/ack/snapshot paths, JSONL IO, surface map, whitelist, SQL and package-manager collection, normalized-name conflict detection, native-command adapter, logging shim) |
