...
namespace ATAP.Utilities.BuildTooling {
    ...
    public static class Utilities {
        ...
        public static bool GetVersion(TaskLoggingHelper log, string versionFile, string aTAPBuildToolingConfiguration, string aTAPBuildToolingDebugVerbosity, out long? build, out int? majorVersion, out int? minorVersion, out int? patchVersion, out string packageVersion, out int? revision) {
        ...
        public static bool SetVersion(TaskLoggingHelper log, string versionFile, string aTAPBuildToolingConfiguration, string aTAPBuildToolingDebugVerbosity, long build, int majorVersion, int minorVersion, int patchVersion, string packageVersion, int revision) {
            // Log the method entry if Debug and Trace
            if(string.Equals(aTAPBuildToolingConfiguration, "Debug", StringComparison.OrdinalIgnoreCase)
                && string.Equals(aTAPBuildToolingDebugVerbosity, "Trace", StringComparison.OrdinalIgnoreCase)) {
        ...
        public static bool TryParsePackageVersion(string stringPackageVersion, out bool? isPublicReleasePackage, out int? major, out int? minor, out int? patch, out string label, out int? labelCount) {
            ...
            if(groups["isNotPublicReleasePackage"].Value == null) {
    ...
    public class UpdateVersion : Task {
        public override bool Execute() {
            ...
            bool isGoodPackageversion = Utilities.TryParsePackageVersion(_packageVersion,
