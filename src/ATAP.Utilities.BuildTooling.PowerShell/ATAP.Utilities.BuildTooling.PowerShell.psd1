...
@{
    ...
    FunctionsToExport    = @('Add-ScopeCreepIdea', 'Add-SharedFileContent',
        ...
        'Remove-BuildMasterRelease', 'Remove-BuildMasterScript', 'Remove-ObjAndBinSubDirectories', 'Remove-ProGetApiKeys',
        ...
        'Resolve-PSModuleMetadata', 'Save-SprintRetrospectiveSnapshot',
        ...
        'Update-BlocksInCsproj', 'Update-OverviewWorkspaceStableInfo',
