...
| -------------- | ------------------- | ------------------------------------------------------------------------------ |
| Feature start  | None                | Create prerelease suffix (e.g. `0.1.0-featureA.3`); experimental feed only.    |
...
| Feature end    | None                | Stop emitting that feature's prerelease suffix; archive the BuildMaster release record. |
