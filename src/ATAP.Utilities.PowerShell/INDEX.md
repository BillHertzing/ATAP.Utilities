...
| [Initialize-SqlServiceLogin.ps1](public/Initialize-SqlServiceLogin.ps1)                                 | Generic idempotent SQL Server Windows login, database user, and db_owner role setup for a local service account; generalizes `Initialize-ProGetSqlServiceLogin` function for real local Windows accounts such as SvcProGet and SvcBuildmaster. |
