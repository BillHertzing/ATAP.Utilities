...
export class mainViewTreeDataProvider implements vscode.TreeDataProvider<mainViewTreeItem> {
  ...
  const command: vscode.Command = {
    ...
    const rootItems = [
      new mainViewTreeItem('RootItem1', vscode.TreeItemCollapsibleState.Collapsed, generateGUID()),
      new mainViewTreeItem('RootItem2', vscode.TreeItemCollapsibleState.Collapsed, generateGUID())
    ];
  ...
  private getSubItems(element: mainViewTreeItem): mainViewTreeItem[] {
    ...
    const subItems = [
      new mainViewTreeItem('SubItem1', vscode.TreeItemCollapsibleState.None, generateGUID()),
      new mainViewTreeItem('SubItem2', vscode.TreeItemCollapsibleState.None, generateGUID())
    ];
