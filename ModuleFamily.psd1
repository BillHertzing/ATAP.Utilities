@{
  ...
  Members = @(
    @{ Name = 'ATAP.Utilities.BuildTooling.Common.PowerShell'; Guid = '99E5815E-2A11-41F1-9D65-09BDF53E0790'; Dependencies = @(); MinimumVersions = @{} }
    @{ Name = 'ATAP.Utilities.BuildTooling.PesterScaffolding.PowerShell'; Guid = 'C986DA8E-1854-4A9A-8D3F-9AE97E65A3AC'; Dependencies = @('ATAP.Utilities.BuildTooling.Common.PowerShell'); MinimumVersions = @{ 'ATAP.Utilities.BuildTooling.Common.PowerShell' = '0.1.0' } }
    @{ Name = 'ATAP.Utilities.BuildTooling.GitWorktree.PowerShell'; Guid = '1E070AD5-6431-4C3E-B7E6-BC69B9CD5AF3'; Dependencies = @('ATAP.Utilities.BuildTooling.Common.PowerShell'); MinimumVersions = @{ 'ATAP.Utilities.BuildTooling.Common.PowerShell' = '0.1.0' } }
    ...
    @{ Name = 'ATAP.Utilities.BuildTooling.PowerShell'; Guid = 'DBD8663F-C30C-4702-B97A-5365529B4D15'; Dependencies = @(); MinimumVersions = @{} }
  )
}
