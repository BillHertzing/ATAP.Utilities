...
| `Get-SqlServiceLoginGrantTarget`   | [public/Get-SqlServiceLoginGrantTarget.ps1](public/Get-SqlServiceLoginGrantTarget.ps1)     | Read-only inventory of databases eligible for a host-local service-account grant; requires an explicit local host, account, and named-instance allow-list and reports fail-closed exclusion reasons.                            |
