...
SourceSha256: e83b38dfa25fa05b586c2cec4ad04bc3db196128544d7b896816d9b4cf113cb1
...
`Install-Module -Repository powershellget-stable` resolves dependencies only against that feed. `PSFramework 1.14.457` is available from the stable feed; use normal dependency resolution and never improvise `-SkipDependencies` inline.
