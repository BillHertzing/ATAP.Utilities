...
The state is named 'quickPickState' and is transitioned into via the 'quickPickEvent'.
the 'quickPickEvent' is defined in setup->types->events as ' |{ type: 'quickPickEvent'; kindOfEnumeration: QuickPickEnumeration }'
