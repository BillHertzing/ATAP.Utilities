...
| Environment / Workstation Setup       | `NewComputerSetup.md`                          | NewComputerSetupUsingAnsible, NewOrganizationSetup, DevEnvironment, WSL2Setup, VisualStudioExtensions, ConfigRootKeys-and-HostSettings, IAC-Windows-Scripts-Migration, `src\ATAP.Utilities.SystemParityMonitor.PowerShell\Documentation\Overview.md` and `InstallationAndTroubleshooting.md` (host-pair parity architecture plus Windows 10/11 install, registration, and live failure recovery; journal every `utat022`/`utat01` machine-state change before execution, Task 12.38.f; moved from ATAP.IAC 2026-07-07); modules: `src\ATAP.Utilities.ConfigRootKeys.Powershell`, `src\ATAP.Utilities.IAC.Ansible.Powershell`, `src\ATAP.Utilities.SystemParityMonitor.PowerShell` |
