...
| Database & Flyway                     | `Database-Change-Unit-and-Flyway-Promotion.md` | `ATAPUtilities-Database-0.1.3-Release-Record.md` (BuildMaster/ProGet live release, checksum-repair backup, final tier proof), Database-Package-\* decisions, Database-MultiDB-Future-Requirements, Developer-SqlServerInstances-Runbook, ATAPUtilities-Instantiation-Tables; machine provisioning and settings-backed `C:\LocalDBs\<INSTANCE>\{Data,Log,Backup}\` topology: `NewComputerSetup.md` / `NewComputerSetupUsingAnsible.md`; module: `src\ATAP.Utilities.DatabaseManagement.Powershell` |
