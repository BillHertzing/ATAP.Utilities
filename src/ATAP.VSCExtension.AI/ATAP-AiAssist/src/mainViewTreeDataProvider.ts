...
export class mainViewTreeDataProvider
  implements vscode.TreeDataProvider<mainViewTreeItem>
{
  private _onDidChangeTreeData: vscode.EventEmitter<mainViewTreeItem | null> =
    new vscode.EventEmitter<mainViewTreeItem | null>();
  readonly onDidChangeTreeData: vscode.Event<mainViewTreeItem | null> =
    this._onDidChangeTreeData.event;
  private message: string;

  constructor(private readonly logger: ILogger) {
    this.logger = new Logger(this.logger, "mainViewTreeDataProvider");
