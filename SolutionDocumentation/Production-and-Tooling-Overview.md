...
| `CSharp-Packages-Versioning.md`        | NBGV `version.json` at repo root and per-project overrides; version-height rules; prerelease-label promotion (Sprint→Alpha→Beta→QA→stable); `nbgv` CLI usage; SemVer-2.0 compliance gotchas.  | covered by [0109-nbgv-version-label-promotion](../../_Planning-wt-12-sprint-0006-work-items/Explainers/0109-nbgv-version-label-promotion.md) + [BuildMaster-ProGet-CSharp-Package-Pipeline §3](BuildMaster-ProGet-CSharp-Package-Pipeline.md)     |
| `CSharp-Packages-Pack-and-Push.md`     | `dotnet pack` for each project; meta-package aggregation (`ATAP.Utilities.csproj`); `dotnet nuget push` with `--api-key`; ProGet flatcontainer-only limitation; cache clearing after re-push. | covered by [BuildMaster-ProGet-CSharp-Package-Pipeline §5-§7](BuildMaster-ProGet-CSharp-Package-Pipeline.md) + [SharedVSCode ProGet.instructions.md](../../SharedVSCode-wt-40-sprint-0006-work-items/.github/instructions/ProGet.instructions.md) |
| `CSharp-Packages-Test-Process.md`      | xUnit test project conventions; `dotnet test` invocation; code coverage via coverlet; test-artifact collection for BuildMaster.                                                               |                                                                                                                                                                                                                                                   |
| `CSharp-Central-Package-Management.md` | Migration from `<PackageReference Update>` in `Directory.Build.targets` to `Directory.Packages.props`; framework-conditional versions; 85-package inventory.                                  | covered by [plan-fixDotnetBuild.prompt.md](plan-fixDotnetBuild.prompt.md)                                                                                                                                                                         |
...
| Planned doc                              | Scope                                                                                                                                                                                          | Status                                                                                                                                                                                                                                                                                                   |
| ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `PowerShell-Modules-Build-Process.md`    | Role of `module.build.ps1` (InvokeBuild driver); 5-tier task pipeline; manifest (`.psd1`) generation; `.psm1` assembly from `public/` and `private/`; snippet-template reuse.                  | partially covered by [src/.../5Tier tasks for module.build.ps1.md](../src/ATAP.Utilities.BuildTooling.PowerShell/Documentation/5Tier%20tasks%20for%20module.build.ps1.md) + [5tier Implementation plan.md](../src/ATAP.Utilities.BuildTooling.PowerShell/Documentation/5tier%20Implementation%20plan.md) |
| `PowerShell-Modules-Versioning.md`       | NBGV or equivalent for PowerShell modules; manifest-version sync; prerelease labels on PSGallery/ProGet PowerShell feeds.                                                                      | gap                                                                                                                                                                                                                                                                                                      |
| `PowerShell-Modules-Pack-and-Publish.md` | `.nuspec` generation; `.nupkg` creation; publish via `Publish-PSResource` (PSResourceGet v3+); ProGet PowerShell feed (`powershell-experimental` / `-development` / …); PSModulePath behavior. | partially covered by [Deep Dive on Building Modules…md](../src/ATAP.Utilities.BuildTooling.PowerShell/Documentation/Deep%20Dive%20on%20Building%20Modules%20and%20Publishing%20to%20Powershell%20Package%20Repositories.md) + [Building §Powershell Packaging](Building.md)                              |
| `PowerShell-Modules-Test-Process.md`     | Pester 5 layout (`RegularTests` / `RequiresNewProcess`); PSFramework logging; tag/new-process filtering; `Invoke-Pester` invocation.                                                           | partially covered by [TestingMethodology.md](TestingMethodology.md)                                                                                                                                                                                                                                      |
| `PowerShell-Script-Consolidation.md`     | Phase-0 consolidation of build/sprint scripts into `ATAP.Utilities.BuildTooling.PowerShell`.                                                                                                   | covered by [\_Planning/Plan-PowershellScriptUpdate.md](../../_Planning-wt-12-sprint-0006-work-items/Plan-PowershellScriptUpdate.md)                                                                                                                                                                      |
...
| [0109-nbgv-version-label-promotion.md](../../_Planning-wt-12-sprint-0006-work-items/Explainers/0109-nbgv-version-label-promotion.md)                       | NBGV T1–T5 label mapping, `version.json` edits, `nbgv` CLI                               | Substantive — authoritative         |
...
- `CSharp-Packages-Build-Process.md` — consolidated build walkthrough from source to local `.nupkg`.
- `CSharp-Packages-Test-Process.md` — xUnit conventions, coverlet, artifact collection. Note: [TestingMethodology.md](TestingMethodology.md) currently covers only Pester.

### 5.2 ATAP.Utilities PowerShell Modules

- `PowerShell-Modules-Versioning.md` — the PowerShell-side analogue of NBGV mechanics.
- `PowerShell-Modules-Build-Process.md` — completion of the partial `module.build.ps1` design docs into a step-by-step builder's guide.
...
- **C# xUnit testing methodology** — currently absent from [TestingMethodology.md](TestingMethodology.md).
