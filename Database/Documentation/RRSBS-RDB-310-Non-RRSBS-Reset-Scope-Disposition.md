...
| `ATAPUtilities.GetRuleByName` | 1 | Retire | It is excluded from the new baseline.  No drop is authorized; it remains a legacy compatibility surface until its consumer map has no references. | RDB-600/RDB-655 successor and RDB-670 retirement gate. |
