...
$global:configRootKeys = @{
  ...
  'GeneratedPowershellNuGetPackageConfigRootKey'                                           = 'GeneratedNuGetPackageSubdirectory'
  ...
  'GeneratedPowershellChocolateyPackageConfigRootKey'                                      = 'GeneratedChocolateyPackageSubdirectory'
