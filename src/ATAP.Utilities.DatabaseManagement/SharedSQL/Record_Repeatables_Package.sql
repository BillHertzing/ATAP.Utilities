...
INSERT dbo.SchemaManifest
  (PackageName, PackageVersion, GitTag, GitCommit)
VALUES
  (@PackageName ,@PackageVersion ,@GitTag ,@GitCommit);
...
INSERT dbo.SchemaManifestFile
  (ManifestId, FileName, FileType, Sha256Hex)
SELECT @ManifestId ,v.FileName ,v.FileType ,v.Sha256Hex
FROM (VALUES $(ValuesList)) AS v
(FileName, FileType, Sha256Hex);
