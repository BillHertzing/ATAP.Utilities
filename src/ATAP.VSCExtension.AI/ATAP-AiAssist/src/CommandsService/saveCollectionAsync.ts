...
export async function saveTagCollectionAsync(
  logger: ILogger,
  data: IData,
): Promise<void> {
  try {
    ...
    HandleError(
      ...
      `failed calling data.fileManager.saveTagCollectionAsync()`,
    );
  }
}

export async function saveCategoryCollectionAsync(
  logger: ILogger,
  data: IData,
): Promise<void> {
  try {
...
export async function saveQueryFragmentCollectionAsync(
  logger: ILogger,
  data: IData,
): Promise<void> {
  try {
...
export async function saveAssociationCollectionAsync(
  logger: ILogger,
  data: IData,
): Promise<void> {
  try {
...
export async function saveConversationCollectionAsync(
  logger: ILogger,
  data: IData,
): Promise<void> {
  try {
