...
`Register-PSRepository -Name "PSResourceGetProductionLocalFilesystemRepository" -SourceLocation "C:\Dropbox\whertzing\Repositories\PSResourceGet\Production\" -InstallationPolicy Trusted`
