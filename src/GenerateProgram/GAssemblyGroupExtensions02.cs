...
namespace GenerateProgram {
  ...
  public static partial class GAssemblyGroupExtensions {
    ...
    public static GAssemblyGroup GAssemblyGroupGHBSConstructor(string gAssemblyGroupName = default, string subDirectoryForGeneratedFiles = default, string baseNamespace = default) {
