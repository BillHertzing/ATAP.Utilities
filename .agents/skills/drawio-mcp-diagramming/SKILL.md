...
description: "Use when building or editing draw.io diagrams via the drawio MCP server: icon conventions, edge/label fanning rules, and the pre-finalisation layout checklist."
---
