...
| `AceCommander-Release-Runbook.md`         | End-to-end release: build → test → publish → deploy; IIS app pool provisioning; bootstrap Windows Service; client bundle publish.              | partially covered by [AceCommander-Modernization-Plan §5](../../Ace-wt-45-Sprint-0015-work-items/SolutionDocumentation/AceCommander-Modernization-Plan.md)                                                                                                                                                                      |
...
| `SharedVSCode-PowerShell-Functions.md`   | `ATAP.Utilities.BuildTooling.PowerShell` module import path; `New-SprintStage1` / `New-SprintStage2` direct fallback dot-source of replacement public functions; `Set-WorktreeJunctions`; `Invoke-WithFileLock`; transition plan to publish as a ProGet-hosted module. | gap                                                                                                                                                                                                                                         |
...
| **Backup / disaster preparedness**              | [Backup-SqlServer-ProGet-BuildMaster.md](Backup-SqlServer-ProGet-BuildMaster.md) + [Backup-ProGet-BuildMaster-ApplicationData.md](Backup-ProGet-BuildMaster-ApplicationData.md) (moved from `_Planning/Explainers/0021`+`0021a`, 2026-07-06) | `Invoke-SqlServerBackup.ps1`, Cobian Reflector integration, `C:\Dropbox\Backups\utat022\` layout. [Disaster Preparedness.md](Disaster%20Preparedness.md) is still largely a skeleton. |
...
| [Backup-SqlServer-ProGet-BuildMaster.md](Backup-SqlServer-ProGet-BuildMaster.md)       | SQL backup via dbatools + Cobian, storage layout                                         | Substantive                         |
| [Backup-ProGet-BuildMaster-ApplicationData.md](Backup-ProGet-BuildMaster-ApplicationData.md)   | ProGet / BuildMaster application-data backup                                             | Substantive                         |
...
| Doc                                                                                                                                                                      | Topic(s)                                                                             | Depth               |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------- |
| [AceCommander-Modernization-Plan.md](../../Ace-wt-45-Sprint-0015-work-items/SolutionDocumentation/AceCommander-Modernization-Plan.md)                           | 12-week roadmap: ProGet feeds, BuildMaster OtterScript, versioning, IIS provisioning | Substantive roadmap |
...
| [.github/instructions/Bitwarden.instructions.md](../../SharedVSCode-wt-40-sprint-0006-work-items/.github/instructions/Bitwarden.instructions.md)     | `Get-SecretATAP`, BW_SESSION, User-scope env vars                           | Substantive                             |
...
| [IAC-Windows-Scripts-Migration.md](IAC-Windows-Scripts-Migration.md) (moved from ATAP.IAC, 2026-07-06)                                                           | Migration plan: ATAP.IAC PowerShell → ATAP.Utilities + ProGet publish | Substantive plan |
| [ConfigRootKeys-and-HostSettings.md](ConfigRootKeys-and-HostSettings.md) (§9 absorbed the former ATAP.IAC doc, 2026-07-06) | Two-tier config system, package-repository dimensions                 | Substantive      |
